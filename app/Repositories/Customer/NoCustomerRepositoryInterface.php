<?php
/**
 * NoCustomerRepositoryInterface.php
...
/**
 * Interface NoCustomerRepositoryInterface
 *
 */
interface NoCustomerRepositoryInterface
{
    ...
    /**
     * Sum of transfers in period without a customer, grouped per currency. Amounts are always positive.
     *
     * @param Carbon          $start
     * @param Carbon          $end
     * @param Collection|null $accounts
