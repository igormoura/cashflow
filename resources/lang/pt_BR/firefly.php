...
return [
    ...
    'mapbox_api_key'                            => 'Para usar o mapa, obtenha uma chave API do <a href="https://www.mapbox.com/">Mapbox</a>. Abra seu arquivo <code>.env.local</code> e insira este código <code>MAPBOX_API_KEY=</code>.',
    ...
    'customers'                                 => 'Clientes',
    'edit_customer'                             => 'Editar cliente ":name"',
    'no_customer'                               => '(sem cliente)',
    'customers'                                 => 'Clientes',
    'customer'                                  => 'Cliente',
    'delete_customer'                           => 'Apagar cliente ":name"',
    'deleted_customer'                          => 'Cliente ":name" apagado',
    'store_customer'                            => 'Gravar cliente',
    ...
    'no_categories_create_default'          => 'Criar um cliente',
    'no_customers_title_default'            => 'Vamos criar um cliente!',
    'no_customers_intro_default'            => 'Você ainda não possui clientes.',
    'no_customers_imperative_default'       => 'Os clientes são criados automaticamente quando você cria transações, mas você também pode criar uma manualmente. Vamos criar uma agora:',
    'no_customers_create_default'           => 'Criar um cliente',
